...
/**
 * <p></p>
 * <p>Created by qrf on 2017/7/13.</p>
 */
public class MysqlGenerator {

    private static final String PACKAGE_NAME = "com.kbss.admin";
    private static final String MODULE_NAME = "cms";
    private static final String OUT_PATH = "D:\\develop\\code";
    private static final String AUTHOR = "qrf";

    private static final String DRIVER = "com.mysql.jdbc.Driver";
    private static final String URL = "jdbc:mysql://rm-wz98z3y7alr1kkiq2yo.mysql.rds.aliyuncs.com:3306/kbsedu?useUnicode=true&characterEncoding=UTF-8";
    private static final String USER_NAME = "root";
    private static final String PASSWORD = "Kbss2018";
...
//                        .setTablePrefix(new String[]{"bs_"})// 此处可以修改为您的表前缀
